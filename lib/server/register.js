...
export const initRoutes = (
  ...
  if (rootPageRelay && getModelList().indexOf(rootPageRelay) < 0) log('warn', `Unknown root page's name: ${rootPageRelay}.`);
  if (rootPageRelay) routes.http['/'] = htmlPageRender(rootPageRelay);
