        ...
        rules: [
          {
            test: /\.js$/,
            use: {
              loader: resolve(__dirname, './webpackScanner.js'),
              options: {
                parseFilterComponents: webpackConfig.parseFilterComponents || ['/', '/dialogs/'],
                parseFilterServices: webpackConfig.parseFilterServices || ['/'],
                cwd: process.cwd()
              }
            },
