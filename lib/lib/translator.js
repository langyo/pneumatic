...
const dfsFactory = (platform, translator, extraArgs = {}) => tasks => {
  let translated = [], tags = {};
  for (let task of tasks) {
    ...
    const translatorRet = translator(task.$$type)(task, extraArgs);
    if (translatorRet) translated = [...translated, ...translatorRet];
  }
